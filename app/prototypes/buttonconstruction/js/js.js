function Prototype() {
    ...
    this.init = function () {
        ...
        $('.createButtonJSON').click(this.createJSON);
    ...
    this.createJSON = function () {
        var buttons = [];
        for (var i = 0; i < $('.createButtonJSONForm').length; i++) {
            var button = {
                "value": $(".createButtonJSONForm").find('input[name="buttonvalue"]')[i].value,
                "colour": $(".createButtonJSONForm").find('select[name="buttoncolour"]')[i].value,
                "text": $(".createButtonJSONForm").find('input[name="buttontext"]')[i].value
            }
            console.log(button);
            buttons.push(button);
        }
